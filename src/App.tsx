  ...
  return (
    <div className="min-h-screen flex flex-col bg-canvas-texture text-[#1A1A1E] font-sans selection:bg-[#B34728] selection:text-[#FAF7F2]">
      ...
      <a
        ...
        title="Open AI Chatbot (the-entrance.ai.studio)"
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-4 py-3 rounded-full bg-[#B34728] hover:bg-[#8F341C] text-[#FAF7F2] border border-[#D4881A]/40 shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all group cursor-pointer"
      >
        <div className="relative flex items-center justify-center">
          <Bot className="w-5 h-5 text-[#FAF7F2] group-hover:rotate-6 transition-transform" />
          <span className="absolute -top-1 -right-1 flex h-2.5 w-2.5">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#EBB04D] opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#D4881A]"></span>
          </span>
        </div>
        <div className="flex flex-col text-left">
          <span className="text-xs font-semibold leading-tight font-sans tracking-wide">
            AI Chatbot
          </span>
          <span className="text-[10px] text-[#FAF7F2]/80 leading-none font-mono">
            the-entrance ↗
          </span>
        </div>
      </a>
